...
<section id="work-block">
	...
	<section class="block">
		<div class="row-fluid first">
			...
			<div class="left2">
				<h2>Custom Ruby on Rails Modules</h2>
				<p>We used our expertise in Ruby on Rails to code the Data & Statistics section, making it easy for users to view country-based statistics using the custom filtering mechanism. We used an existing Rails module and customized it to fit Clean Cookstoves’ objectives.</p>
			</div>
		...
		<div class="row-fluid">
			...
			<article class="span4 l">
				...
				<h2>Sortable Statistics</h2>
				<p>Whether it is with sortable lists, filter mechanisms, or keyword searching, we made sure that it was easy for users to access all of the valuable resources and tools. With improved search functionality on the site, it is simple for users to easily discover the information they need.</p>
			</article>
