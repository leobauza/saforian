...
<article class="hero wagner-hero ">
	<div class="inner">
		<blockquote>
...
<section id="work-block">
	<section class="block">
		<h1>Wagner Custom Skis</h1>
		<article class="row-fluid">
			<div class="span6">
				<p>Wagner, a luxe ski designer and manufacturer, asked Saforian to refresh the digital presence for Wagnerskis.com with the goal of driving online sales and audience engagement. We started by developing a fresh brand identity that captures the spirit of this high-end company across all of its products and media. Using the brand as our foundation for everything, we created a digital experience to build brand loyalty and foster fan participation. Using visually stunning graphics and customized traffic generators, we crafted an engaging digital experience that <strong>increased online sales by 90% and site visits from 3,582 to 120,049 (3,251%)</strong> over a 4 year period. From a “Design Your Own Skis” contest and an opportunity to win a luxury ski vacation, our savvy social media experts made it possible for Wagner to have ongoing conversations with customers and the ski community.</p>
			</div>
			<div class="span6 l">
				<ul class="highlights">
					<li><strong>Industry</strong><span>Commercial</span></li>
					<li><strong>Solutions</strong><span>Branding, Website, Campaign Support, Custom Product Integration, Custom Application, Responsive, eNewsletter</span></li>
	...
	<section class="block">
		...
		<figure class="center-img3">
			<img src="../../images/caseStudies/wagner_storephoto.png" alt="Instore Photo">
		</figure>
		
		<div class="row-fluid">
			<article class="span4">
				<figure class="center-img2">
					<img src="../../images/caseStudies/wagner_logo.png" alt="Expression Engine Logo">
				</figure>
			</article>
			<article class="span8">
				<h2>Wagner Logo</h2>
				<p>Think simple. Think impactful and step into the Wagner brand. A custom brand needs a custom logo mark. Saforian was privileged to provide Wagner with a custom logo mark that has become the synonymous calling card for the Wagner Custom Skis brand.</p>
			</article>
		...
		<div class="row-fluid">
			<article class="span4">
				<figure class="center-img">
					<img src="../../images/caseStudies/global_ski_logo.png" alt="CodeIgniter">
				</figure>
				<h2>Revenue Generation</h2>
				<p>Because the shopping experience isn’t exactly like your average e-commerce experience in which you select an item, pay for it, and it arrives on your doorstep, we developed a custom Zencart based eCommerce system. This system facilitates the addition of custom skis into visitors’ shopping carts and manages the procurement and payment processes.</p>
			</article>
			<article class="span4">
				<figure class="center-img">
				...
				<p>We worked closely with Wagner to define the required integration points into Wagner’s proprietary Skier DNA backend manufacturing system. Details regarding a buyer’s skiing preferences get collected and transformed into milling specs that then in-turn result in the perfect pair of skis.</p>
			</article>
			<article class="span4 l">
				...
				<p>To accommodate Wagner’s diverse audience, we created an experience that is accessible across a variety of platforms. Whether you prefer to use an iPad, iPhone, computer, or other mobile device, the experience is responsively refined to work seamlessly for each device and medium.</p>
			</article>
		</div> <!-- end of second row -->
	</section> <!-- end of block -->	
	...
	<section class="block">
		...
		<figure class="center-img">
			<img src="../../images/caseStudies/wagner_largeimage1.jpg" alt="Large Image">
		</figure>
		<figure class="center-img">
			<img src="../../images/caseStudies/wagner_largeimage2.jpg" alt="Large Image">
		</figure>
		<figure class="center-img">
			<img src="../../images/caseStudies/wagner_largeimage3.jpg" alt="Large Image">
		</figure>
	</section> <!-- end of block -->
	...
	<section class="block-last">
		<article class="row-fluid">
			...
			<div class="span5 l">
				...
				<p>Since most Wagner Skis are custom made to order, you can’t go into a store and buy a pair that has been individually made for you. So to help retailers get potential ski junkies interested in the Wagner DNA custom design process, we worked with Wagner to develop iPad app. The app is based on Wagner’s proprietary Skier DNA system and presents potential buyers with questions about their terrain preferences, ski experience, binding options, and body composition that allow Wagner to collect the data necessary for creating individualized skis.</p>
			</div>
		</article>
	</section> <!-- end of block -->
