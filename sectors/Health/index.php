...
<section class="capabilities-bg">
	<div class="std-block">
		...
		<div id="iso-wrap" class="our-work row-fluid" data-section="our-work">
			<section id="iso-cont">
				...
				<article class="item safo-client span4 l">
					<a href="../../CaseStudies/KBD" class="ignore"><img src='../../images/site/client-thumbnails/kbd.jpg' alt='KBD' /></a>
		...
		<div class="row-fluid padbottom">
			<article class="span3">
				<p class="clients"><strong>American Red Cross</strong><br/>Campaign Strategy, Design, Multimedia Development</p>
			</article>
			<article class="span3">
				<p class="clients"><strong>The Center for Disease Control</strong><br/>Informational Architecture, Design, Development</p>
			</article>
			<article class="span3">
				<p class="clients"><strong>Merck</strong><br/>Informational Architecture, Design, Development</p>
			</article>
