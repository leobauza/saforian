...
<section id="header-wrap">
	<header id="site-header" class="group">
		<div id='brand'>
			<h1>saforian</h1>
			<a href="http://www.saforian.com"><img src="../images/logo_saforian_ie.png" alt="Logo Safosolo White"></a>
		</div>
		<nav id="site-nav">
...
<section class="novaslider-bg">
		<div class="std-header first nova-block" id="one">
			<div class="grant">
				<p>Over the last 3 years, Saforian developed two innovative mobile and tablet based products.  One was designed to revolutionize the way members of any organization communicate and the other is a presentation tool giving individuals the ability to present their ideas on the go. These products have incredible potential and we are excited to get them to market ASAP.  With this Mission Main Street℠ Grant we would be able to get them to the public by spring of next year.  <br/>Thanks for your vote.</p>
				<div class="links">
					<div class="left-side">
						<a class="vote" href="https://www.missionmainstreetgrants.com/business/detail/98474">vote</a>
						<span class="share">Share:</strong></span>
					</div>
					<div class="right-side">
						...
						<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=xa-526965db5f873a29"></script>
						<!-- AddThis Button END -->
					</div>
				</div>
			</div>
